 ...
 * <p>
 * This class is registered as a custom Forge GUI overlay positioned <i>below</i> (i.e. drawn
...
public final class VisualizerRenderer {
    ...
    /**
     * Invoked once per frame from the {@code RegisterGuiOverlaysEvent} handler registered in
     * the main mod class. {@code partialTick} is unused here since bar movement is driven by
     * a real-time delta computed from {@link System#nanoTime()} rather than the render partial
     * tick, but it's accepted to match Forge's {@code IGuiOverlay} functional interface.
     */
