...
/**
 * Declares every user-facing setting using NeoForge's {@link ModConfigSpec} builder.
 ...
 * <p>
 * Values are exposed as public final {@code ModConfigSpec.*Value} fields; callers read them
 * with {@code .get()}. NeoForge caches these reads efficiently, so it is safe to call
...
public final class VisualizerConfig {
    ...
    public final ModConfigSpec.BooleanValue visualizerEnabled;

    public final ModConfigSpec.IntValue barWidth;
    public final ModConfigSpec.IntValue barSpacing;
    public final ModConfigSpec.IntValue barCount;
    ...
    public final ModConfigSpec.IntValue color1;
    public final ModConfigSpec.IntValue color2;
    public final ModConfigSpec.IntValue color3;
    public final ModConfigSpec.BooleanValue useThirdColor;
    public final ModConfigSpec.DoubleValue rainbowSpeed;
    public final ModConfigSpec.DoubleValue rainbowSaturation;
    public final ModConfigSpec.DoubleValue rainbowBrightness;

    public final ModConfigSpec.ConfigValue<String> outputDeviceId;
    public final ModConfigSpec.DoubleValue sensitivity;
    public final ModConfigSpec.IntValue fftSize;
    public final ModConfigSpec.DoubleValue smoothing;

    public final ModConfigSpec.IntValue targetFps;
    public final ModConfigSpec.IntValue updateRateMs;
    public final ModConfigSpec.DoubleValue interpolationStrength;

    public final ModConfigSpec.BooleanValue mirrorMode;
    public final ModConfigSpec.DoubleValue bassBoost;
    public final ModConfigSpec.EnumValue<FrequencyScaling> frequencyScaling;
    public final ModConfigSpec.BooleanValue animationEasing;
    public final ModConfigSpec.BooleanValue silenceDetection;

    public final ModConfigSpec spec;

    public VisualizerConfig(ModConfigSpec.Builder builder) {
